...
```{r wikidata-plots, message = FALSE, warning=FALSE, out.width="100%"}
plots_list <- generate_ids(
...
```{r wikidata-swertia-1, warning=FALSE, out.width="100%"}
plots_list$plots$Swertia
```

#### Compounds found in Swertia (per species)
```{r wikidata-swertia-2, warning=FALSE, out.width="100%"}
plots_list$plots$Swertia_grouped
```

### Compounds found in Kopsia

```{r wikidata-kopsia-1, warning=FALSE, out.width="100%"}
plots_list$plots$Kopsia_grouped
```

### Comparison

```{r wikidata-swertia-kopsia, warning=FALSE, out.width="100%"}
plots_list$plots$special
```
