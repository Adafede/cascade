...
```{r tima-plots-h, message = FALSE, warning=FALSE, fig.height=9}
#| dev: svglite

plots$histogram
```

```{r tima-plots-t, message = FALSE, warning=FALSE}
#| dev: svglite

plots$treemap
```

```{r tima-plots-s, message = FALSE, warning=FALSE}
#| dev: svglite
...
```{r tima-plots-1, warning=FALSE, fig.height=12}
#| dev: svglite
