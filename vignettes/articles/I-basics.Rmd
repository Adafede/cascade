...
```{r check-alignment-default, echo=FALSE, message=FALSE, warning=FALSE, out.width="100%"}
check_chromatograms_alignment(show_example = TRUE)
```

Or, with more details:

```{r check-alignment-2, echo=FALSE, message=FALSE, warning=FALSE, out.width="100%"}
...
```{r check-alignment-3, echo=FALSE, message=FALSE, warning=FALSE, out.width="100%"}
check_chromatograms_alignment(
  show_example = TRUE,
  time_min = 0.5,
  time_max = 35.0,
...
```{r check-integration-1, echo=FALSE, message=FALSE, warning=FALSE, out.width="100%"}
...
```{r check-integration-2, echo=FALSE, message=FALSE, warning=FALSE, out.width="100%"}
check_peaks_integration(
  show_example = TRUE
)
```

We now recommend you to read the [next vignette](https://adafede.github.io/cascade/articles/II-preparing.html).
