...
For some other available helper functions, we now recommend you to read the [next vignette](https://adafede.github.io/cascade/vignettes/articles/III-bonus.html).
