...
```{r process-plot-pseudochromatograms, message = FALSE, warning=FALSE, out.width="100%"}
...
```{r treemap-major, warning=FALSE, out.width="100%"}
plots_list$treemaps$peaks_maj
```

### Treemap semi-quantitative (minor)

```{r treemap-minor, warning=FALSE, out.width="100%"}
...
```{r treemap-both, warning=FALSE, out.width="100%"}
