...
Thanks for using cascade! Before filing an issue, there are a few places to
...
- If it's a bug: you're in the right place, [file an
  issue](https://github.com/adafede/cascade/issues/new).
...
requests](https://github.com/adafede/cascade/issues) to make sure the bug hasn't
